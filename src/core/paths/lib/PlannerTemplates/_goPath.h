...
class _goPath : public pp::PathPlanner<DOF> {
    ...
    public:
        ...
        _goPath() {BlueRov = new root::MeanTraj(6,15,3);};
        ~_goPath() override { delete BlueRov;}
        ...
        void compute() override {
            ...
            BlueRov->add_DOF(MAX_ACCEL, 0, this->init_pose(this->THZ), this->goal_pose(this->THZ), 5, false);
//                           in there ->^^
...
// this->init_vel(this->Z_THVEL)
        ...
        void store_results() override { 
            ...
            cout << this->path_angular.transpose() << endl;
            cout << "rows: " << this->path_trans.rows() << " cols: " << this->path_trans.cols() << endl;
